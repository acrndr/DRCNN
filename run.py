...
def main():
    ...
    parser.add_argument('--model', type=str, default='FEDformer',
                        help='model name, options: [DRCNN, FEDformer, Autoformer, Informer, Transformer]')
    ...
    parser.add_argument('--res', type=int, default=2, help='dimension of model')
    parser.add_argument('--div', type=int, default=2, help='dimension of model')
